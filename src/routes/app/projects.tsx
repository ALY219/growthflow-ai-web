    ...
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your website generation projects</p>
        </div>
        ...
        <Card className="border-border bg-card border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1 mb-4">
              Create a project to start generating websites with AI.
            </p>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <Button onClick={handleCreate} className="w-full" disabled={!name.trim() || createProject.isPending}>
